...
//        group.setGroupType("GROUP_USER");
//        group.setCreatedUser("admin");
//        group.setCreatedTime(124124131);
//        groupDao.createGroup(group);

        // get all group
//        Group[] groups = groupDao.getGroups();
//        System.out.println(123);

        // get group by TYPE
//        Group[] groups = groupDao.getGroupsByType("GROUP_USER");
//        System.out.println(123);

        // get group by Id
//        Group groups = groupDao.getGroupsById(2);
//        System.out.println(123);

        // update group
//        Group group = new Group();
//        group.setID(2);
//        group.setGroupName("group2_update");
//        group.setGroupType("GROUP_ROLE");
//        group.setCreatedUser("admin");
//        group.setCreatedTime(124124131);
...
//        strings.add("1");
//        strings.add("2");
//        groupDao.addUsersToGroup(7, strings);

        // remove users from group
//        List<String> strings = new ArrayList<String>();
//        strings.add("1");
//        groupDao.removeUsersFromGroup(7, strings);

        // add roles to group
//        List<String> strings = new ArrayList<String>();
//        strings.add("1");
//        strings.add("2");
//        groupDao.addRolesToGroup(7, strings);

        // remove role from group
//        List<String> strings = new ArrayList<String>();
//        strings.add("1");
//        groupDao.removeRolesFromGroup(7, strings);
