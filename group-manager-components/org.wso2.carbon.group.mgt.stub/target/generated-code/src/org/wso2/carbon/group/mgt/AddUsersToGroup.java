 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addUsersToGroup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addUsersToGroup",
    ...
    public static class Factory{
        ...
        */
        public static AddUsersToGroup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddUsersToGroup object =
                new AddUsersToGroup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addUsersToGroup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddUsersToGroup)org.wso2.carbon.group.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
