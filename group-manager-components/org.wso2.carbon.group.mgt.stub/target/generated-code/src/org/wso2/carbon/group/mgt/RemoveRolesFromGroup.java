 ...
 */
            ...
            /**
            *  RemoveRolesFromGroup bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveRolesFromGroup
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeRolesFromGroup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeRolesFromGroup",
                ...
                if (localGroupIdTracker){
                                    namespace = "http://mgt.group.carbon.wso2.org";
                             ...
                             if (localRoleNames!=null) {
                                   ...
                                   for (int i = 0;i < localRoleNames.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://mgt.group.carbon.wso2.org", "roleNames", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static RemoveRolesFromGroup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveRolesFromGroup object =
                new RemoveRolesFromGroup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeRolesFromGroup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveRolesFromGroup)org.wso2.carbon.group.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.group.carbon.wso2.org","groupId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.group.carbon.wso2.org","roleNames").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://mgt.group.carbon.wso2.org","roleNames").equals(reader.getName())){
