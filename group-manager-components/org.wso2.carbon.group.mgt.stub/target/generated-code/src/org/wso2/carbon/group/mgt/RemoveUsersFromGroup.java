 ...
 */
            ...
            /**
            *  RemoveUsersFromGroup bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeUsersFromGroup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeUsersFromGroup",
                ...
                if (localGroupIdTracker){
                             ...
                             if (localUserNames!=null) {
                                   ...
                                   for (int i = 0;i < localUserNames.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://mgt.group.carbon.wso2.org", "userNames", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static RemoveUsersFromGroup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveUsersFromGroup object =
                new RemoveUsersFromGroup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeUsersFromGroup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveUsersFromGroup)org.wso2.carbon.group.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.group.carbon.wso2.org","userNames").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://mgt.group.carbon.wso2.org","userNames").equals(reader.getName())){
