 ...
 */
            ...
            /**
            *  AddRolesToGroup bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddRolesToGroup
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addRolesToGroup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addRolesToGroup",
    ...
    public static class Factory{
        ...
        */
        public static AddRolesToGroup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddRolesToGroup object =
                new AddRolesToGroup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addRolesToGroup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddRolesToGroup)org.wso2.carbon.group.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
